...
if(!function_exists('gp_video')) {
	function gp_video($atts, $content = null) {
		extract(shortcode_atts(array(
		 ...
		 require(gp_inc . 'options.php'); global $is_IE, $is_gecko, $gp_settings;
		...
		<div class="sc-video <?php echo $align; ?> <?php echo $name; ?>" style="width: <?php echo $width; ?>px;">
			...
			<?php if($vimeo) { ?>
				...
				<iframe src="http://player.vimeo.com/video/<?php echo $vimeoid; ?>?byline=0&amp;portrait=0&amp;autoplay=<?php echo $autostart; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>" allowFullScreen></iframe>
